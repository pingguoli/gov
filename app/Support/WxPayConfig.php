...
use App\Wxpay\WxPayConfigInterface;
...
class WxPayConfig extends WxPayConfigInterface
{
    ...
    {
        !is_string($type) or $this->_type = strtolower($type);
    }
    ...
    {
        return config("site.wxpay.$this->_type.app_id");
    }

    public function GetMerchantId()
    {
        return config("site.wxpay.$this->_type.mch_id");
    }
    ...
    {
        return config("site.wxpay.$this->_type.key");
    }

    public function GetAppSecret()
    {
        return config("site.wxpay.$this->_type.app_secret");
    }
