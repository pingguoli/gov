    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="col-lg-4">
                    <h3 class="box-title">{{ __('New Menu') }}</h3>
                </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body pad-10">
                        ...
                        <select class="form-control" name="pid">
                            ...
                            @if(!empty($menuOptions))
                                @foreach($menuOptions as $entry)
                                    <option value="{{ $entry->id }}" @if(old('pid') == $entry->id) selected @endif >{{ $entry->title }}</option>
                                @endforeach
                            @endif
                        </select>
                        @if($errors->has('pid'))
                ...
                <div class="col-lg-4">
                    <div class="form-group @if($errors->has('title')) has-error @endif">
                        ...
                        <input class="form-control" name="title" type="text" placeholder="{{ __('Name') }}" value="{{ old('title') }}">
                        @if($errors->has('title'))
                ...
                <div class="col-lg-4">
                    <div class="form-group @if($errors->has('name')) has-error @endif">
                        ...
                        <input class="form-control" name="name" type="text" placeholder="{{ __('Controller / method') }}" value="{{ old('name') }}">
                        @if($errors->has('name'))
                ...
                <div class="col-lg-4">
                    <div class="form-group @if($errors->has('url')) has-error @endif">
                        ...
                        <input class="form-control" name="url" type="text" placeholder="{{ __('URL') }}" value="{{ old('url') }}">
                        @if($errors->has('url'))
                ...
                <div class="col-lg-4">
                    <div class="form-group @if($errors->has('icon')) has-error @endif">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text" id="show-choice-icon">@if(old('icon'))<i class="fa {{ old('icon') }}"></i>@endif</span></div>
                            <input class="form-control" id="select-icon" name="icon" type="text" placeholder="{{ __('Icon') }}" readonly value="{{ old('icon') }}">
                ...
                <div class="col-lg-4">
                    <div class="form-group @if($errors->has('sort')) has-error @endif">
                        ...
                        <input class="form-control" name="sort" type="text" placeholder="{{ __('Sort') }}" value="{{ old('sort') ?: 100 }}">
                        @if($errors->has('sort'))
